        ...
        {[
          {
            ...
            description: "Our main focus is to work hand in hand with clients to achieve their goals with ease."
          },
          {
            icon: <Users className="w-6 h-6 text-blue-500" />,
            title: "Expert Team",
            description: "We have an excellent team of Transcribers/Native Translator dedicated to deliver errorfree transcripts."
          },
...
export function WhyAudexis() {
  return (
    <>
      <Helmet>
        <title>Why Choose Audexis - Professional Transcription Services | Competitive Pricing</title>
        <meta 
          name="description" 
          content="Discover why Audexis is the leading choice for transcription services. Expert team, competitive pricing starting from $0.85/minute, specialized legal & medical transcription, and guaranteed quality."
        />
        <meta 
          name="keywords" 
          content="transcription services, legal transcription, medical transcription, professional transcribers, native translators, competitive pricing, fast turnaround"
        />

        {/* Open Graph Tags */}
        <meta property="og:title" content="Why Choose Audexis for Professional Transcription Services" />
        <meta property="og:description" content="Industry-leading transcription services with competitive pricing, expert team, and guaranteed quality. Specialized in legal, medical, and general transcription." />
          ...
          {JSON.stringify({
            ...
            "hasOfferCatalog": {
              ...
              "itemListElement": [
                {
                  "@type": "Service",
                  "name": "Legal Proceedings Transcription",
                  "description": "Specialized transcription for trials, hearings, depositions, and EUOs"
                },
                {
                  "@type": "Service",
                  "name": "Interview Transcription",
                  "description": "Transcription for one-to-one interviews, focus groups, and medical research"
                },
                {
                  "@type": "Service",
                  "name": "Captioning Services",
                  "description": "Professional captioning and subtitling services"
                }
              ]
            }
          })}
